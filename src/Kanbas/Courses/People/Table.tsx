      ...
      <table className="table table-striped">
        ...
        <tbody>
          ...
          <tr><td className="wd-full-name text-nowrap">
            ...
            <td className="wd-total-activity">13:30:44</td> </tr>
          <tr><td className="wd-full-name text-nowrap">
              <FaUserCircle className="me-2 fs-1 text-secondary" />
            ...
            <td className="wd-section">S101</td>
            <td className="wd-role">STUDENT</td>
            <td className="wd-last-activity">2024-11-03</td>
            <td className="wd-total-activity">15:57:52</td> </tr>
          <tr><td className="wd-full-name text-nowrap">
              <FaUserCircle className="me-2 fs-1 text-secondary" />
            ...
            <td className="wd-role">STUDENT</td>
            <td className="wd-last-activity">2024-11-01</td>
            <td className="wd-total-activity">17:05:01</td> </tr>
